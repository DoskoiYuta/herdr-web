...
// drifts from the real rendered header height, CodeView's item-height
...
/**
 * Derive the CodeView itemMetrics (lineHeight, diffHeaderHeight) / CSS custom
 * property pair from a font size, clamped to a sane range. Keeping these in
 * sync is required — see plan §6.3 — otherwise CodeView's virtualization math
